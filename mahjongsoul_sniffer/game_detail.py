...
from mahjongsoul_sniffer.mahjongsoul_pb2 import (
    GameDetailRecords,
    RecordAnGangAddGang,
    RecordChiPengGang,
    RecordDealTile,
            ...
            "properties": {
                ...
                "mode": {
                    ...
                    "properties": {
                        ...
                        "detail_rule": {
                            "title": "ゲームルール詳細",
                            "$comment": "TODO: 要調査, 段位戦などルールのプリセットがある場合は meta.mode_id が参照され，ここはすべてデフォルト値？",
                            "type": "object",
                        },
                    },
...
def validate(message: bytes) -> None:  # noqa: C901
    wrapper = Wrapper()
    ...
    try:
        jsonschema.validate(instance=response_json, schema=_GAME_RECORD_SCHEMA)
    ...
    schema_list = [
        (
            b"^\n\x12\\.lq\\.RecordNewRound\x12",
            ".lq.RecordNewRound",
            RecordNewRound,
            _NEW_ROUND_SCHEMA,
        ),
        (
            b"^\n\x12\\.lq\\.RecordDealTile\x12",
            ".lq.RecordDealTile",
            RecordDealTile,
            _DEAL_TILE_SCHEMA,
        ),
        ...
        (
            b"^\n\x0e\\.lq\\.RecordHule\x12",
            ".lq.RecordHule",
            RecordHule,
            _HULE_SCHEMA,
        ),
        (
            b"^\n\x10\\.lq\\.RecordNoTile\x12",
            ".lq.RecordNoTile",
            RecordNoTile,
            _NO_TILE_SCHEMA,
        ),
        (
            b"^\n\x0f\\.lq\\.RecordLiuJu\x12",
            ".lq.RecordLiuJu",
            RecordLiuJu,
            _LIU_JU_SCHEMA,
        ),
...
def get_game_abstract(message: bytes) -> dict:
    ...
    return {"uuid": uuid, "start_time": start_time}
